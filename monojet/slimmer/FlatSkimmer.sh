...
CrombieFlatSkimmer  --cut 'fatjet1Pt>0' --tree 'events' --copy 'htotal' --run 'runNum' --lumi 'lumiNum' --freq 100000 --numproc 1 --indir /afs/cern.ch/work/d/dabercro/public/Winter15/allData --outdir $CrombieSkimDir --json $CrombieGoodRuns -d
