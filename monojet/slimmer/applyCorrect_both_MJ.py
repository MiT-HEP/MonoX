...
kfactor  = Corrector.MakeCorrector('kfactor','genBos_pt','genBos_PdgId == 22','files/uncertainties_24bins.root',['GJets_1j_NLO/nominal_G','GJets_LO/inv_pt_G'])
...
wkfactor = Corrector.MakeCorrector('wkfactor','genBos_pt','abs(genBos_PdgId) == 24','files/uncertainties_24bins.root',['WJets_012j_NLO/nominal','WJets_LO/inv_pt'])
