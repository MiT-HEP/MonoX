void trigeff(){
    ...
    //"/afs/cern.ch/work/z/zdemirag/work/run2/monojet13TeV/MonoX/monojet/GoodRuns/
    //eos/cms/store/user/zdemirag/MonoJet/Full/V003/
    ...
    TString offline = "jet1Pt>100. && TMath::Abs(jet1Eta)<2.5 && jet1isMonoJetId==1 && n_tightlep > 0 && n_looselep>0 && abs(jet1DPhiMet)>0.4";
