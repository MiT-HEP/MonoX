...
def plotPreFitPostFit(region):
  ...
  f_mlfit = TFile('mlfit_WZ.root','READ')
  ...
  c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/Monojet/forBrandon/sys/zw_prefit_postfit_"+region+".pdf")
  c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/Monojet/forBrandon/sys/zw_prefit_postfit_"+region+".png")
  c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/Monojet/forBrandon/sys/zw_prefit_postfit_"+region+".C")
