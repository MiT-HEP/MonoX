...
def plotPreFitPostFit(region):
  ...
  datalab = {"singlemuon":"Wmn", "dimuon":"Zmm", "signal":"signal"}

  #f_mlfit = TFile('mlfit.root','READ')
  #f_mlfit = TFile('mlfit_ZgammaW.root','READ')
  f_mlfit = TFile('mlfit_Zonly.root','READ')
  ...
  channel = {"singlemuon":"1", "dimuon":"2", "signal":"3"}
  mainbkg = {"singlemuon":"wjets", "dimuon":"zll", "signal":"zjets"}
  ...
  c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/Monojet/forBrandon/sys/zonly_prefit_postfit_"+region+".pdf")
  c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/Monojet/forBrandon/sys/zonly_prefit_postfit_"+region+".png")
  c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/Monojet/forBrandon/sys/zonly_prefit_postfit_"+region+".C")
