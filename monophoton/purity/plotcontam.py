...
for source in sources:
    ...
    for loc in Locations[:1]:
        ...
        for pid in PhotonIds:
            purities[source][loc][pid] = {}
            for ptCut in PhotonPtSels[1:]:
                purities[source][loc][pid][ptCut[0]] = {}
                for metCut in MetSels[1:2]:
                    purities[source][loc][pid][ptCut[0]][metCut[0]] = {}
                    ...
                    for chiso in ChIsoSbSels[:]:
                        purities[source][loc][pid][ptCut[0]][metCut[0]][chiso[0]] = {}
                        ...
                        for line in condorFile:
                            if "Nominal purity is:" in line:
                                ...
                                if tmp:
                                    ...
                                    #print purity
                        purities[source][loc][pid][ptCut[0]][metCut[0]][chiso[0]] = purity 
                        ...
                        if not match:
                            ...
                            purities[source][loc][pid][ptCut[0]][metCut[0]][chiso[0]] = (102.5, 0.0)
                        condorFile.close()
                    purityFile.write(r"\hline")
                    purityFile.write("\n")
            ...
            for metCut in MetSels[1:2]:
                ...
                for chiso in ChIsoSbSels:                
                    ...
                    for ptCut in PhotonPtSels[1:]:
                        ...
                        impurity = float(purities[source][loc][pid][ptCut[0]][metCut[0]][chiso[0]][0])
                        uncertainty = float(purities[source][loc][pid][ptCut[0]][metCut[0]][chiso[0]][-1])
