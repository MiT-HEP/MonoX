...
combineTool.py -M Impacts -d ${outname}.root -m 125 --robustFit 1 --freezeNuisances lumiscale --setPhysicsModelParameterRanges r=-5.0,5.0 --expectSignal=${signal} -t -1 --doFits --parallel 24
