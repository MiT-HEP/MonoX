...
ignoredNuisances = {
    ...
    ('zg', 'monophin'): ['leptonVetoSF', 'vgPDF', 'vgQCDscale', 'EWK', 'gec'],
    ('wg', 'monophin'): ['leptonVetoSF', 'vgPDF', 'vgQCDscale', 'EWK', 'gec'],
    ('halo', 'monophin'): ['haloShape', 'haloNorm']
...
scaleNuisances = ['lumi', 'photonSF', 'customIDSF', 'leptonVetoSF', 'egFakerate', 'spikeNorm', 'minorQCDScale', 'muonSF', 'electronSF'] # lepton SF also flat for now
