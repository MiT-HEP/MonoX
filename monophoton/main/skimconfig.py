...
defaultSelectors = {
    ...
    'monomuAllPhoton': selectors.monomuonAllPhoton,
...
data_sph += ['dimu', 'dimuAllPhoton', 'diel', 'monomu', 'monomuAllPhoton', 'monoel'] 
...
selectors = {
    ...
    'wnlg-500': applyMod(selectors.kfactor, mc_sig + mc_lep),
