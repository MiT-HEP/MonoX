...
phoSelection    = "(" + allSelections + "((photonIsTight == 1 || (photonPtRaw < 175 && n_loosepho != 0)) && n_looselep == 0 && n_tau == 0))"
signalSelection = "(" + allSelections + "(n_looselep == 0 && n_loosepho == 0 && n_tau == 0))"

skimmingSelection = "((" + ZmmSelection + ") || (" + ZeeSelection + ") || (" + WmnSelection + ") || (" + WenSelection + ") || (" + signalSelection + ") || (" + phoSelection + "))"
